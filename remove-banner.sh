...
tput cup 6 30
echo -e "\x1b[42m Tonmoy Thech by TONMOY HASAN\x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Have you subscribe my channel Tonmoy Thech for more hacking videos (y/n)? \e[m "
read answer
...
tput cup 20 0
figlet -f slant "Tonmoy Thech by TONMOY HASAN" |lolcat
echo " "
echo " "
